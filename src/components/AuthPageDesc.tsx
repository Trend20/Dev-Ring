  ...
  return (
    <div className="flex w-3/4 min-h-screen flex-col p-10 justify-center items-start max-md:w-full max-md:p-3 max-md:max-h-80 max-md:hidden">
      ...
      <p className="w-3/4 mt-10 leading-8 text-lg max-md:w-full max-md:mt-5 max-md:leading-6">
        Join DevRing today and unlock the full potential of your local developer
        community. Start building meaningful connections, fostering professional
        growth, and discovering new opportunities in your tech-savvy
        neighborhood. <strong>DevRing</strong> - Where Local Meets Digital!
      </p>
    </div>
  );
};
